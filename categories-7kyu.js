...
Output
Output will consist of a list of string values (in Haskell and C: Open or Senior) stating whether the respective member is to 
...
function openOrSenior(data) {
  //Access the arrays in the arrays by looping through it
  let categories = [];
  data.forEach((grade, handicap) => {
    if (grade >= 55 && handicap > 7) {
      categories.push("Senoir");
